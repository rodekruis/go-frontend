export default {
  ...
  threeWFilterOrganizationalUnitPlaceholer: 'All Organizational Units',
  threeWFilterPartnerPlaceholer: 'All Partners',
  threeWFilterActivityPlaceholer: 'All Activities',
  threeWFilterSubactivityPlaceholer: 'All Subactivities',
  ...
  projectFormOrganizationalUnit: 'Organizational Unit',
  projectFormOrganizationalUnitHelpText: 'Select Organizational Unit that is carrying out the activity.',
  projectFormOrganizationalUnitTooltip: 'It can be either the Organizational Unit where the disaster has taken place or a different Organizational Unit that is carrying out an activity in support of the response.',
  projectFormPartner: 'Partner',
  projectFormPartnerHelpText: 'Select Partner that is helping out with the activity.',
  projectFormPartnerTooltip: 'It can be a Partner that is carrying out an activity in support of the response.',
  ...
  projectFormActvityTitle: 'Activity',
  projectFormActivity: 'Activity: ',
  projectFormFormActivityText: 'Choose the option that best represents the activity.',
  projectFormSubactivity: 'Subactivity: ',
  projectFormSubactivityText: 'Choose the option that best represents the specific activity.',
  projectFormActivityTooltip: 'The subactivity options are based on the selected activity.',
  projectFormActivityLabel: 'Activity',
  projectFormSubactivityLabel: 'Subactivity',
  projectFormUnitsTitle: 'Units',
  projectFormUnitsMeasurementMetric: 'Measurement Metric: ',
  projectFormUnitsMeasurementMetricText: 'Choose how to measure the units.',
  projectFormUnitsQuantity: 'Quantity: ',
  projectFormUnitsQuantityTest: 'Enter the quantity according to the selected measurement unit.',
  projectFormUnitsTooltip: 'Specify the metric to define the value of the activity.',
  projectFormUnitsMeasurementMetricLabel: 'Measurement Metric',
  projectFormUnitsQuantityLabel: 'Quantity',
  projectFormProvinceDistrict: 'Province and District',
  projectFormProvinceDistrictText: 'Choose Province and District.',
  projectFormWhereProvinceLabel: 'Province',
  projectFormWhereDistrictTitle: 'District',
  projectFormWhereMunicipalityLabel: 'Municipality',
  projectFormWhereWardLabel: 'Ward',
  projectFormMunicipalityWardTitle: 'Municipality and Ward',
  projectFormMunicipalityWardText: 'Choose Municipality and Ward.',
  projectFormDeliveryPointTitle: 'Delivery Point',
  projectFormDeliveryPointText: 'Place of the service delivery.',
  projectFormDeliveryPointTooltip: 'Place of the service delivery.',
  projectFormWhereDeliveryPointLabel: 'Place',
  projectFormWhereDeliveryServiceNameLabel: 'Name of Delivery Service',
  ...
  projectFormBeneficiaryTypeTitle: 'Types of Beneficiaries',
  projectFormTargetedTotalPeople: 'Total People Targeted',
  projectFormTargetedTotalPeopleText: 'Total number of people to reach through the work.',
  projectFormTargetedTotalPeopleTooltip: 'The totals for: &#13;Male - People who identify as having the male gender &#13;Female - People who identify as having the female gender &#13;Other - Other can include data such as “other sex/gender”, “undisclosed”, “unknown”, etc &#13;Total - The total number of people included in the subcategories above',
  projectFormTargetedMalePeople: 'Targeted Males',
  projectFormTargetedMalePeopleText: 'People who identify as having the male gender.',
  projectFormTargetedMalePeopleTooltip: 'Enter the number of males under the appropriate age group.',
  projectFormTargetedFemalePeople: 'Targeted Females',
  projectFormTargetedFemalePeopleText: 'People who identify as having the female gender.',
  projectFormTargetedFemalePeopleTooltip: 'Enter the number of females under the appropriate age group.',
  projectFormTargetedLGBTIQPeople: 'Targeted LGBTIQ',
  projectFormTargetedLGBTIQPeopleText: 'People who identify as lesbian, gay, bisexual, transgender/transsexual, intersex and queer/questioning.',
  projectFormTargetedLGBTIQPeopleTooltip: 'Enter the number of LGBTIQs under the appropriate age group.',
  projectFormAge0005: '0-5',
  projectFormAge0612: '6-12',
  projectFormAge1317: '13-17',
  projectFormAge1829: '18-29',
  projectFormAge3039: '30-39',
  projectFormAge4049: '40-49',
  projectFormAge5059: '50-59',
  projectFormAge6069: '60-69',
  projectFormAge7079: '70-79',
  projectFormAge80Plus: '80+',
  projectFormTargetedMalePeopleLabel: 'Male',
  projectFormTargetedFemalePeopleLabel: 'Female',
  projectFormTargetedOtherPeopleLabel: 'Other',
  projectFormTargetedLGBTIQPeopleLabel: 'LGBTIQ',
  projectFormTargetedTotalPeopleLabel: 'Total',
  projectFormTargetedOtherPeople: 'Targeted Others',
  projectFormTargetedOtherPeopleText: 'Other can include data such as “other sex/gender”, “undisclosed”, “unknown”, etc',
  projectFormTargetedOtherPeopleTooltip: 'Enter the number of people.',
  projectFormReachedTotalPeople: 'Total People Reached',
  projectFormReachedTotalPeopleText: 'Enter the total number of people reached already with (TOTAL, male, female, LGBTIQ, other).',
  projectFormReachedTotalPeopleTooltip: 'Please follow the Counting People Reached guidelines as establishing the Federation-wide Databank and Reporting System.',
  projectFormReachedMalePeopleLabel: 'Male',
  projectFormReachedFemalePeopleLabel: 'Female',
  projectFormReachedLGBTIQPeopleLabel: 'LGBTIQ',
  projectFormReachedTotalPeopleLabel: 'Total',
  projectFormReachedLGBTIQPeople: 'Reached LGBTIQ',
  projectFormReachedLGBTIQPeopleText: 'People who identify as lesbian, gay, bisexual, transgender/transsexual, intersex and queer/questioning.',
  projectFormReachedLGBTIQPeopleTooltip: 'Please follow the Counting People Reached guidelines as establishing the Federation-wide Databank and Reporting System.',
  projectFormReachedFemalePeople: 'Reached Females',
  projectFormReachedFemalePeopleText: 'People who identify as having the female gender.',
  projectFormReachedFemalePeopleTooltip: 'Please follow the Counting People Reached guidelines as establishing the Federation-wide Databank and Reporting System.',
  projectFormReachedMalePeople: 'Reached Males',
  projectFormReachedMalePeopleText: 'People who identify as having the male gender.',
  projectFormReachedMalePeopleTooltip: 'Please follow the Counting People Reached guidelines as establishing the Federation-wide Databank and Reporting System.',
  projectFormReachedOtherPeople: 'Reached Others',
  projectFormReachedOtherPeopleText: 'Other can include data such as “other sex/gender”, “undisclosed”, “unknown”, etc',
  projectFormReachedOtherPeopleTooltip: 'Please follow the Counting People Reached guidelines as establishing the Federation-wide Databank and Reporting System.',
  projectFormReachedOtherPeopleLabel: 'Other',
  projectFormTargetedVulnerable: 'Targeted Vulnerable',
  projectFormTargetedVulnerableText: 'Vulernable people include women who are pregnant and people with disability.',
  projectFormTargetedVulnerableTooltip: 'Enter the number of vulnerable people within the numbers reported above. These entries do not add toward the total to avoid double counting.',
  projectFormTargetedPregnantWomenLabel: 'Pregnant Women',
  projectFormTargetedPeopleWithDisabilityLabel: 'People with Disability',
  projectFormReachedVulnerable: 'Reached Vulnerable',
  projectFormReachedVulnerableText: 'Vulernable people include women who are pregnant and people with disability.',
  projectFormReachedVulnerableTooltip: 'Enter the number of vulnerable people within the numbers reported above. These entries do not add toward the total to avoid double counting.',
  projectFormReachedPregnantWomenLabel: 'Pregnant Women',
  projectFormReachedPeopleWithDisabilityLabel: 'People with Disability',
